...
|---|---|---|---|
| [`bicep-avm-code`](docs/bicep-avm-code.md) | Authors/refactors Azure Bicep with direct AVM modules, golden examples, environment params, and posture checks. | Authoring contract, anti-patterns, capability discovery, golden Bicep examples, AVM posture checker | `bicep` |
...
Codex installs user skills under:
